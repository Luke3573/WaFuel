...
workbook = xlsxwriter.Workbook('c:\\WaFuelULP.xlsx')
...
read_file = pb.read_excel (r'c:\WaFuelULP.xlsx')
read_file.to_csv (r'c:\WaFuelULP.csv', index = None, header=True)

df = pb.read_csv('c:\WaFuelULP.csv')
